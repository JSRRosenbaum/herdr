...
pub(crate) use self::sidebar::{
    agent_panel_entries_from, compact_separator, expanded_sidebar_sections,
    resolved_token_spans, separator, sidebar_agent_rows, sidebar_section_divider_rect,
    sidebar_space_rows, AgentPanelEntry, AgentTokenContext, ResolvedToken, ResolvedTokenKind,
    SpaceTokenContext,
};
